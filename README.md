...
- Giving feedback comment and rating.
...
```bash
git clone https://github.com/shafiuyushawu/feedback-app
```
...
- Interact with an API to store comment and rating
...
[Kindly raise issue here](https://github.com/shafiuyushawu/feedback-app/issues)
...
- I would like express my sincere appreciation to Brad Traversy for coming out with these curriculum.
